module DecidimOCL::ParticipatoryProcesses::ParticipatoryProcessHelper
  def step_dates(participatory_process_step)
    ...
    case dates.count
    when 0 then I18n.t('decidim_ocl.participatory_processes.participatory_process_helper.step_dates.no_dates')
