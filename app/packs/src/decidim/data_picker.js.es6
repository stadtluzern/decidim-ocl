/**
 * Fix the broken "close" links on modal dialogs. Remove this file once we upgrade to decidim 0.25.
 * See https://github.com/decidim/decidim/issues/7621
 * See https://github.com/stadtluzern/decidim-ocl/issues/48
 */
